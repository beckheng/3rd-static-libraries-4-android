...
./configure \
	...
	CFLAGS="-nostdlib" \
	LDFLAGS="-Wl,-rpath-link=$ANDROID_NDK_ROOT/platforms/android-19/arch-arm/usr/lib/ -L$ANDROID_NDK_ROOT/plaforms/android-19/arch-arm/usr/lib/ --sysroot=$ANDROID_NDK_ROOT/platforms/android-19/arch-arm/" \
